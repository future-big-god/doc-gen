...
import com.xstore.partner.doc.domain.Result;
...
public class HttpPostTest
{
    ...
    {
        String response = new HttpClient().sendJsonPost("https://cf.jd.com/rest/api/content/",
                "",
    ...
    public void testGet() throws UnsupportedEncodingException {
        String response = new HttpClient().sendJsonGet("https://cf.jd.com/rest/api/content/?spaceKey=7fresh&title=杀杀杀",
                new Auth("zhoujun5","!Sandbar731208"));
